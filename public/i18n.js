...
export const DICT = {
  ko: {
    ...
    helpGithub: '카드의 GitHub 줄 — origin 저장소와 공개/비공개 배지 (gh CLI 로그인 필요, 없으면 ?)',
  },
  en: {
    ...
    helpGithub: 'GitHub line on a card — origin repo and public/private badge (needs gh CLI login; shows ? otherwise)',
  },
  ja: {
    ...
    helpGithub: 'カードの GitHub 行 — origin リポジトリと公開/非公開バッジ (gh CLI ログイン必要。無い場合は ?)',
  },
};
